const profileImg1 = new URL(
  '../../public/images/testimonials/avatar-1.svg',
  import.meta.url,
);
const profileImg2 = new URL(
  '../../public/images/testimonials/avatar-1.svg',
  import.meta.url,
);
...
const testimonials = [
  ...
  {
    text: "“ Quentin a été un élément important de mon équipe et j'apprécie ses efforts et le travail qu'il a effectué sur nos projets de développement web. Je le recommande ! ”",
