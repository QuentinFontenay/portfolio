export const services = [
    {
        icon: process.env.PUBLIC_URL + '/images/building-website.svg',
        title: 'Projet Web',
    ...
    {
        icon: process.env.PUBLIC_URL + '/images/facebook-advertisement-tutorial.svg',
        title: 'Marketing Facebook',
        desc: 'Mise en place de publicités afin de promouvoir votre marque, votre association'
    },
    {
        icon: process.env.PUBLIC_URL + '/images/website-maintenance.svg',
