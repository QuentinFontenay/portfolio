export const services = [
    ...
    {
        icon: new URL('../../public/images/services/concept-of-seo-ranking.svg', import.meta.url),
        alt: 'image SEO',
    ...
    {
        icon: new URL('../../public/images/services/collaborate.svg', import.meta.url),
        alt: 'collaboration',
    ...
    {
        icon: new URL('../../public/images/services/website-designing.svg', import.meta.url),
    ...
    {
        icon: new URL('../../public/images/services/facebook-advertisement-tutorial.svg', import.meta.url),
    ...
    {
        icon: new URL('../../public/images/services/website-maintenance.svg', import.meta.url),
